...
Try {
	...
	[string]$appName = 'QGIS'
	[string]$appVersion = '3.30'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '04/06/2023'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'qgis-bin, designer, python3, saga_gui' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		$applicationList = 'QGIS'
		ForEach($installedApplication in $applicationList) {
			...
			ForEach($application in $installedApplicationList) {
				...
				if($application.UninstallString) {
					...
					ElseIf($application.UninstallString.contains("uninstall.exe")) {
						Write-Log -Message "QGIS Installation Status: $installedApplication" -Source 'Pre-Installation' -LogType 'CMTrace'
						...
						Execute-Process -Path $uninstallString -Parameters "/S" -WindowStyle "Hidden" -PassThru
						If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
					}
					Else {
		...
		Remove-Item "$env:Public\Desktop\GRASS GIS*.lnk" -Force
		Get-ChildItem -Path "$env:Public\Desktop\QGIS*" -Recurse | Remove-Item -force -recurse
		Remove-Item "$env:Public\Desktop\QGIS*" -Force
		...
		$exitCode = Execute-MSI -Action Install -Path "$dirFiles\QGIS-OSGeo4W-3.30.1-1.msi" -Parameters '/qn' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		...
		Remove-Folder -Path "$Env:Public\Desktop\QGIS 3.30.1"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'qgis-bin, designer, python3, saga_gui' -CloseAppsCountdown 60
		...
		$exitCode = Execute-MSI -Action Uninstall -Path "{A79857B9-F25E-1014-AB38-71FB8B569609}" -Parameters '/qn' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCO5WxCgJtVV1vq
# cylGUKmL3YZfxE1ZQwYsxQLtAMAu66CCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg6Y/FtQAxlMFS
# l7yqB6pgetZUUPykndNt9z/5RjqE3kswDQYJKoZIhvcNAQEBBQAEggGAUveqs6Vc
# 8Xqi7SMNfw1tJCqZ5GCWNraTzn4347CUDJ00WbZhw4jI/SruD078fT++CiY5BbSX
# q2VSMovEncY2f6Qiv+EhNxuBxDnluat9XeM4njMNcc0I7XtVYEIcy7tm3SJL0kRq
# V7L7CRoH/w+3ozJzlkxzuDODxfIq2dw0pVWa7TDaWig5sOIzDtytglXnSF/zLLt+
# VvLnHuaXCNv7e0c+AmEe8DNeDnDomDD/wl1IF0UPpLc2H4zDG0emGBmjYupFcEYb
# RFEXbn1m0ApdINcDXgOSy6tOPCJAn+tZQfiEfoIobo9SAUvjA4uvkaXzlEEcRtL0
# HdA6ld3g8BQDyr4UUkaVaujG1LbSpke2jy56EDt/O3Sni4ovDm7qgc7IUhjCOlr3
# aHxG39kIH6IRv/yqtZLplITjqdwOxD3Qcyd6vzQQx3cxqX4eVZHH0Zhq6J+ppqMe
# i3IrncJzeHyn5IAIsR34GwayunRBtPDX4o0fjMguQPvqSbfS8k0/B1pSoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzA0MDYy
# MTEzMTdaMD8GCSqGSIb3DQEJBDEyBDCNF5cUO85f3vZhWYOHjLVXa96FPT/OefLN
# aQjtmPgXcmGigTTc5ShEtj02sUNpIpowDQYJKoZIhvcNAQEBBQAEggIAMBPExP9t
# fLeVfF3A7FRWdOjMiIamNlsWsvgavcakkPQRoVa5IpOPLitIb/3OuS3nsFW/ly1m
# Ac/lexV8tklSX8PLMHXTTg+WQYCpisJdgI1BUF80SPlxGs7jzZLAodYaAB84AN/z
# CKlC+2XlHr/RTBh0/5Cld8dvTIdGOxxv9d29PY0/uEWkPNAgdai9Smzn29gvmrWe
# wz0XcAW931z0G4ejLTGvxjJUu6lLUwAKv33bYd53s83DxL8L5/FzekPs4FqxVWEQ
# ReCxli2UwvqaZq4Ma/Uisbrsw3B5CJEhW9/MiA6K5jCB6UNBwm6fHE8k4VrTbzox
# kvf4GIjtl3GvbahZdIaOF+ytxyjEJpl2CiGtf+EbOAMzB/P3m1GiO8Xl3+9hyzHN
# Y18zw89ELq1xaAmkCDQUnRrM4EZW2HEj3L3UZfOqU45Pjd+Z4KXOFnv8R+aDczNY
# 1lXOtWKaNmP5GcjjQSmryS6dkTGbnArqZExEd50uRfQ7m70ubvQiSa35IVrCPkiZ
# 1PAKBahluRjM2kZaBoV/JrvUfrXRqXOvnmL0mzuPX80tcy5jp0cyy/ohMCEVnzIo
# O4XqEpFg8nQnabcPsy4FkMMg5yrXKtMayWrIfOkKc+NoJpXmGbRFli8zHpFQ8t6q
# KaELinYcGiTtSI4RSotepdzptu7ewG+Fqu8=
